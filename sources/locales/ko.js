export default {
	...
	"Settings have been applied":"설정이 적용되었습니다.",
	"View detailed client's":"상세한 클라이언트보기",
	"Born":"타고난",
	"Client's name is ":"고객의 이름 ",
	"Client's last name is ":"고객의 성 ",
	"Client is ":"고객 ",
	"Next birthday is on ":"다음 생일이 켜져 있습니다 ",
	"The position that client occupies within their company":"고객이 회사 내에서 차지하고있는 위치",
	"Not selected":"선택되지 않은",
	"You will receive email notifications about actions performed by this client.":"이 클라이언트가 수행 한 작업에 대한 전자 메일 알림을 받게됩니다.",
	"You will receive no email notifications.":"전자 메일 알림을받지 못합니다.",
	"The city where the client works":"고객이 일하는 도시",
	"The address of the client's office":"고객의 사무실 주소",
	"Not specified":"명시되지 않은",
	"The working email address of the client":"클라이언트의 실제 이메일 주소",
	"The badges unlocked by the client":"클라이언트가 잠금을 해제 한 배지",
	"No badges":"배지 없음",
	"Click to clean the form":"양식을 정리하려면 클릭하십시오.",
	"The card with which the payment was made":"지불 한 카드",
	"Outgoing":"나가는",
	" payment":" 지불",
	"Search for a client":"클라이언트 검색",
	"Reset to default settings":"기본 설정으로 재설정",
	"Choose the language of the interface":"인터페이스 언어 선택",
	"Pick the date format that will be used to display dates in the datatables":"데이터 테이블에 날짜를 표시하는 데 사용될 날짜 형식을 선택하십시오.",
	"Change the color of the sidebar and toolbars":"사이드 바 및 도구 모음의 색상 변경",
